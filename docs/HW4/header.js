function header(opt){
  ...
  $('#navbar').html(str);
  $("html").append('<footer class="fixed-bottom" style="text-align:center; width:100%;"><br><div class="container-fluid bg-secondary p-3"><a href="https://www.linkedin.com/in/jakemartin99/"><img class="rounded" src="../resources/img/linkedin.png" height="50px"></a></div></footer>');
}
